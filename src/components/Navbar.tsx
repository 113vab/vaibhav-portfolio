      ...
      >
        <div className="max-w-7xl mx-auto flex items-center justify-between w-full">
          ...
          <a 
            ...
            className="text-lg font-extrabold tracking-wider bg-gradient-to-r from-red-600 to-rose-500 bg-clip-text text-transparent uppercase flex items-center gap-1.5"
          >
            {profile.name}
          </a>
          ...
          {/* Desktop Right CTA Button with moving reflective sheen */}
